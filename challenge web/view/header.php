...
<nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php?page=categorie&id=1">Navbar</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        <?php if(isset($_SESSION['user'])): ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="?page=categorie&id=2">tech</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?page=categorie&id=3">planet</a>
          </li>
