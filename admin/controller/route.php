...
switch($page)
{
    ...
    case 'poster':
     ...
     case 'ListeNoir':
        include_once 'view/ListeNoir.php';
        break;
    ...
    case 'afficherCommentaires':
        require_once 'controller/VilleCommentaireController.php';
        $controller = new VilleCommentaireController();
        $controller->afficherCommentaires();
        break;
